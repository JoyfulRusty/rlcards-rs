...
from rlcards.agents.dmc_agent.dmc.mahjong import DMCTrainer
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser("DMC Mahjong In RLCard")
	parser.add_argument(
		'--env',
		type=str,
		default='mahjong',
	...
	parser.add_argument(
		'--x_pid',
		default='mahjong',
		help='训练编号(default: mahjong)')

	parser.add_argument(
		'--save_dir',
		default='results/dmc/mahjong_new',
		help='保存训练数据的根目录')
