...
class ConvModel(nn.Module):
	...
	def __init__(
		...
		# 卷积层
		self.conv1 = nn.Conv1d(self.in_planes, 11, kernel_size=(3,), stride=(2,), padding=1, bias=True)
		self.bn1 = nn.BatchNorm1d(11)  # 归一化

		# 残差网络层
		self.layer1 = self._make_layer(BasicBlock, 22, 2, stride=2)
		self.layer2 = self._make_layer(BasicBlock, 44, 2, stride=2)
		self.layer3 = self._make_layer(BasicBlock, 88, 2, stride=2)

		# 全连接层
		self.dense0 = nn.Linear(655, layer_dims[0])
