...
from rlcards.games.sytx.card import SyCard as Card
...
def make_lai_zi():
	...
	num = 0
	lz_encoding_dict = {}
	for card in const.LAI_ZI:
		lz_encoding_dict[card] = num
		num += 1

	return lz_encoding_dict
...
# 构建癞子牌索引，用于解码动作
new_lz_encoding_dict = make_lai_zi()
new_lz_decoding_dict = {new_lz_encoding_dict[key]: key for key in new_lz_encoding_dict.keys()}
