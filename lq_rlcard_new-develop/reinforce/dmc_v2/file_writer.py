...
class FileWriter:
    ...
    def __init__(self, x_pid: str = None, xp_args: dict = None, root_dir: str = '~/palaas'):
        ...
        #     os.symlink(self.base_path, symlink)
    ...
    def log(self, to_log: Dict, tick: int = None, verbose: bool = False) -> None:
        """
        日志文件
        :param to_log: Dictionary of data to log.
        :param tick: Optional tick number.
        :param verbose: Print log message to stdout.
        """
        if tick is not None:
    ...
    def close(self, successful: bool = True) -> None:
        """
        关闭
        :param successful: Whether the run was successful.
        """
