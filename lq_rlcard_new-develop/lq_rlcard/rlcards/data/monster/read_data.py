...
from rlcards.data.monster.data_path import \
    CARD_TYPE_PATH, \
    ACTION_SPACE_PATH, \
    TYPE_CARD_PATH
...
if __name__ == '__main__':
    print("输出 CARD_TYPE_DATA: ", CARD_TYPE_DATA)
    print("输出 ACTION_2_ID: ", ACTION_2_ID)
    print("输出 ID_2_ACTION: ", ID_2_ACTION)
    print("输出 TYPE_CARD_DATA: ", TYPE_CARD_DATA)